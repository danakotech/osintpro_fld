          ...
          <CardContent className="p-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="text-center mb-6">
                <h2 className="text-2xl font-bold text-white mb-2">Iniciar Investigación</h2>
                <p className="text-gray-400">Ingresa la dirección de wallet para comenzar el análisis OSINT</p>
              </div>
            ...
            <div className="mt-6 text-center">
              <p className="text-xs text-gray-500">Soportamos Ethereum, Polygon, BSC y más de 20 blockchains</p>
            </div>
          </CardContent>
        </Card>
      </div>
